...
class SignatureBox extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Signature Box', 'busicon-elementor-extension' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'label_block' => true,
					'default' => __( 'David Xaimul', 'busicon-elementor-extension' ),
				]
			);
			$this->add_control(
				'description_text',
				[
					...
					'default' => __( 'CEO & Founder', 'busicon-elementor-extension' ),
				]
			);
		$this->end_controls_section();
		...
		$this->start_controls_section(
			'signature_section',
			[
				'label' => __( 'Signature', 'busicon-elementor-extension' ),
			]
		);
			$this->add_control(
				'signature_img',
...
*/
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .signature-box' => 'justify-content: {{VALUE}};',
					],
				]
			);
		$this->end_controls_section();
			...
			$this->start_controls_tab(
				...
				$this->add_control(
					...
					[
						...
						'default' => '',
						'selectors' => [
							'{{WRAPPER}} .signature-box .icon i' => 'color: {{VALUE}}',
						],
					]
				);
				$this->add_control(
					...
					[
						...
						'default' => '',
						'selectors' => [
							'{{WRAPPER}} .signature-box .icon i' => 'background: {{VALUE}}',
						],
					]
				);
				$this->add_group_control(
					...
					[
						...
						'selector' => '{{WRAPPER}} .signature-box .icon i',
					]
				);
				$this->add_responsive_control(
					'icon_border_radius',
					[
						...
						'size_units' => [ 'px', 'em', '%' ],
						'selectors' => [
							'{{WRAPPER}} .signature-box .icon i' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
			...
			$this->start_controls_tab(
				...
				$this->add_control(
					...
					[
						...
						'default' => '',
						'selectors' => [
							'{{WRAPPER}} .signature-box:hover .icon i' => 'color: {{VALUE}}',
						],
					]
				);
				$this->add_control(
					...
					[
						...
						'default' => '',
						'selectors' => [
							'{{WRAPPER}} .signature-box:hover .icon i' => 'background: {{VALUE}}',
						],
					]
				);
				$this->add_group_control(
					...
					[
						...
						'selector' => '{{WRAPPER}} .signature-box:hover .icon i',
					]
				);
				$this->add_responsive_control(
					...
					[
						...
						'size_units' => [ 'px', 'em', '%' ],
						'selectors' => [
							'{{WRAPPER}} .signature-box:hover .icon i' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
			$this->end_controls_tab();
		...
		$this->end_controls_tabs();
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors' => [
						'{{WRAPPER}} .signature-box .icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
					'separator' => 'before',
				]
			);
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .signature-box .icon i' => 'height: {{SIZE}}{{UNIT}};',
					],
				]
			);
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .signature-box .icon i' => 'width: {{SIZE}}{{UNIT}};',
					],
				]
			);
			$this->add_group_control(
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .signature-box .icon i' => 'text-align: {{VALUE}};',
					],
				]
			);
		$this->end_controls_section();
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'default' => '',
					'selectors' => [
						'{{WRAPPER}} .signature-box .content h4' => 'color: {{VALUE}}',
					],
				]
			);
			$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .signature-box .content h4',
				]
			);
			$this->add_responsive_control(
				'title_margin',
				[
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors' => [
						'{{WRAPPER}} .signature-box .content h4' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'default' => '',
					'selectors' => [
						'{{WRAPPER}} .signature-box .content p' => 'color: {{VALUE}}',
					],
				]
			);
			$this->add_group_control(
				...
				[
					...
					'label' => __( 'Typography', 'busicon-elementor-extension' ),
					'selector' => '{{WRAPPER}} .signature-box .content p',
				]
			);
			$this->add_responsive_control(
				'description_margin',
				[
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors' => [
						'{{WRAPPER}} .signature-box .content p' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
	...
	protected function render() {
		...
		<?php if($settings['select_style']=='one'){ ?>
			...
			<div class="signature-box style1 <?php echo $settings['icon_position']; ?>">
				...
				<?php if(!empty($settings['signature_img'])){ ?>
				<div class="signature">
					<img src="<?php echo $settings['signature_img']['url'] ?>" alt="">
				</div>
				<?php } ?>
			</div>
